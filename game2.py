...
#Creating borders
    ...
    circle = pygame.draw.circle(test.variables.screen, (test.variables.cstyle), (test.variables.cx, test.variables.cy), 20)
#Border collision
    ...
    if test.varirables.cy - test.variables.am_to_mv == circle.colliderect(line) and pressed[pygame.K_LEFT]:
        print("test")
        test.vaiables.cy = test.variables.cy -3
    else:
